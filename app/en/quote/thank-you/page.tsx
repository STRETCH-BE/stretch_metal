/**
 * RFQ thank-you page — /en/quote/thank-you
 * File path: /app/en/quote/thank-you/page.tsx
 *
 * English mirror of /app/wycena/dziekujemy/page.tsx: one calm black band
 * with the confirmation heading, a three-step "what happens next"
 * (numbered hairline cells from rfq.thanks.steps), the phone number for
 * anything urgent, and two ways back (services / home via routes). No
 * form, no conversion furniture, no MobileStickyCta.
 *
 ...
 *
 * Copy from /content/en/rfq.ts (rfq.thanks); FRAME below holds only
...
const FRAME = {
  ...
  phoneLead: "Something urgent? Call us:",
} as const;
          ...
          <Container>
            ...
            <FadeIn delay={200} className="mt-12">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                <Button href={routes.home.en} variant="ghost-light" size="lg">
                  {rfq.thanks.backHome}
                </Button>
              </div>
            </FadeIn>
