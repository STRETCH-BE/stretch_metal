/**
 * RFQ thank-you page — /wycena/dziekujemy
 * File path: /app/wycena/dziekujemy/page.tsx
 *
 * Post-submit expectation setting, nothing else: one calm black band with
 * the confirmation heading, a three-step "what happens next" (numbered
 * hairline cells from rfq.thanks.steps), the phone number for anything
 * urgent, and two ways back (services / home via routes). No form, no
 * conversion furniture, no MobileStickyCta.
 *
 ...
 * JSON-LD — a receipt page has no business in an index.
 *
 * Copy from /content/rfq.ts (rfq.thanks); FRAME below holds only labels
 * RfqContent has no fields for. The display heading gets the identity's
 * single red accent by tinting the title's last word — derived, not
 * hardcoded, so the content file stays the source of truth.
 */
...
const FRAME = {
  ...
  stepsTitle: "Co dzieje się teraz",
  phoneLead: "Pilna sprawa? Zadzwoń:",
} as const;

export const metadata: Metadata = {
  title: rfq.thanks.metaTitle,
  description:
    "Dziękujemy za przesłanie zapytania. Odpowiemy w ciągu 48 godzin.", // [CONFIRM] 48 h
...
export default function RfqThanksPage() {
  return (
    <>
          ...
          <Container>
            ...
            <FadeIn delay={200} className="mt-12">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                <Button href={routes.home.pl} variant="ghost-light" size="lg">
                  {rfq.thanks.backHome}
                </Button>
              </div>
            </FadeIn>
