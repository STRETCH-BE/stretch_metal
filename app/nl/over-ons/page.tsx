/**
 * About page — /nl/over-ons
 * File path: /app/nl/over-ons/page.tsx
 *
 * Dutch (nl-BE) mirror of /app/en/about/page.tsx: identical section
 * rhythm (dark hero → timeline → story → team → values → sister brands →
 * CTA), copy from /content/nl/about.ts. For the Flemish reader the page's
 * trust argument is doubled: this is a BELGIAN group's own workshop with
 * surplus capacity — Dutch-speaking contact included.
 *
...
import { about } from "@/content/nl/about";
import { nav, footer, stickyCta } from "@/content/nl/ui";

/** Page-frame copy with no AboutContent field — kept minimal on purpose. */
const FRAME = {
  storyImageCaption: "De StretchMetal-hal — lasafdeling en montagezone",
  group: {
    eyebrow: "Stretchgroup",
    title: "De merken van de groep",
    lead: "StretchMetal is de metaalafdeling van de Stretchgroup. De zustermerken van de groep plaatsen spanplafonds in België en Polen — hun montageteams bouwen met de stukken uit deze werkplaats.",
    links: [
      {
        name: siteConfig.group.belgium.name,
        description: "Spanplafonds — België",
        url: siteConfig.group.belgium.url,
      },
      {
        name: siteConfig.group.poland.name,
        description: "Spanplafonds — Polen",
        url: siteConfig.group.poland.url,
      },
    ],
  },
  cta: {
    title: "Nu produceert ze voor u.",
    accent: "u.",
    lead: "Stuur een technische tekening — u ontvangt binnen 48 uur een offerte, gewoon in het Nederlands.",
      ...
      <main id="main">
        <JsonLd
          data={buildBreadcrumbs([
            ...
            { name: "Over ons", url: nlCanonical(routes.about.nl) },
          ])}
        />
            ...
            <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <FadeIn delay={120}>
                <WorkshopImage
                  ...
                  alt="Laskop boven een lastafel — detail uit de werkplaats van StretchMetal"
                  aspect="aspect-[4/5]"
          ...
          <Container>
            ...
            <FadeIn delay={180}>
              <div className="mt-10 flex flex-wrap items-center gap-4">
                ...
                <Button href={routes.contact.nl} variant="ghost-light" size="lg">
                  {FRAME.cta.secondary}
                </Button>
              </div>
            </FadeIn>
