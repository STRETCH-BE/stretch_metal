/**
 * RFQ page — /nl/offerte
 * File path: /app/nl/offerte/page.tsx
 *
 * Dutch (nl-BE) mirror of /app/en/quote/page.tsx: identical section
 * rhythm, copy from /content/nl/rfq.ts, NL routes and .be canonicals.
 * Written for a Flemish/Belgian purchasing manager — the trust rail
 * (vertrouwelijkheid, NDA, rechtstreeks contact met een ingenieur, in het
 * Nederlands) carries the page's argument as much as the form does.
 *
...
const FRAME = {
  breadcrumbHome: "Home",
  breadcrumbSelf: "Offerte aanvragen",
